                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">"I've been shopping on NonstopShop for few months now, and I always find exactly what I need. The selection is unbeatable, the prices are great, and the customer service is top-notch. I recommend it to all my friends and family!.</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">Shopping on this website is incredibly convenient. The website is easy to navigate, the checkout process is seamless, and the customer service is exceptional. Anytime I've had a question or issue, the support team has been quick to respond and resolve it.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">I'm always amazed by the great deals I find on NonStopShop. Not only are the prices competitive, but the frequent sales and discounts make it even more affordable. I feel like I'm getting excellent value for my money with every purchase.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
