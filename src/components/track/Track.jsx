                ...
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg"  >
                            ...
                            <h2 className="title-font font-medium text-lg text-gray-900" >Premium Quality</h2>
                            <p className="leading-relaxed">Our Products are made of best quality materails.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg"  >
                            ...
                            <h2 className="title-font font-medium text-lg text-gray-900" >Premium design</h2>
                            <p className="leading-relaxed">Our peoducts are the best in market.
                            </p>
                        </div>
                    </div>
